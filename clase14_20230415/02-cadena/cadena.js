...
const procesaProducto=(producto, ...descuentos)=>{
    descuentos.forEach(imp=>{
        imp(producto)
    })
    return producto
}
...
let producto1=new Producto('zapatilla',200)

console.log(procesaProducto({...producto1}, validaProducto, desc1, desc2, impuestos, formato))
